pub use self::{
    Amount as SubportfolioBaseBalanceSnapshotForOver366Days_Amount,
    CreatedAt as SubportfolioBaseBalanceSnapshotForOver366Days_CreatedAt,
};
use super::{
    _remote::{
        Asset_ChainId,
...
pub struct SubportfolioBaseBalanceSnapshotForOver366Days {
    pub user_id: User_Id,
