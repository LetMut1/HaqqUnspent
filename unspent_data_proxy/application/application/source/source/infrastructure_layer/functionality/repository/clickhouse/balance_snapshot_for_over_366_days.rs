...
use crate::{
    domain_layer::data::entity::balance_snapshot_for_over_366_days::BalanceSnapshotForOver366Days,
...
impl ClickhouseRepository<BalanceSnapshotForOver366Days> {
    pub async fn find_history<'a>(clickhouse_client: &'a Client, by_1: &'a By1<'_>) -> Result<Vec<BalanceSnapshot>, Auditor<Error>> {
        let balance_snapshot_registry = match Self::find_balance_snapshot_history_(
            clickhouse_client,
            by_1,
            "unspentio.balance_snapshot_for_over_366_days",
