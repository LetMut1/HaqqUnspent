pub use self::{
    Amount as SubportfolioBaseBalanceSnapshotFor120Days_Amount,
    CreatedAt as SubportfolioBaseBalanceSnapshotFor120Days_CreatedAt,
};
use super::{
    _remote::{
        Asset_ChainId,
...
pub struct SubportfolioBaseBalanceSnapshotFor120Days {
    pub user_id: User_Id,
