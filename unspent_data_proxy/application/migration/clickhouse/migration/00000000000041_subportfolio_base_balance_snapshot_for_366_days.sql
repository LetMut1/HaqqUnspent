-- migrate:up
CREATE MATERIALIZED VIEW unspentio.subportfolio_base_balance_snapshot_for_366_days_materialized_view
TO unspentio.subportfolio_base_balance_snapshot_for_366_days
AS
SELECT
...
-- migrate:down
DROP VIEW unspentio.subportfolio_base_balance_snapshot_for_366_days_materialized_view SYNC;