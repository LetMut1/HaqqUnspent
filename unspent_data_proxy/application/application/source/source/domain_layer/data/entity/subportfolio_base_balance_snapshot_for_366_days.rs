pub use self::{
    Amount as SubportfolioBaseBalanceSnapshotFor366Days_Amount,
    CreatedAt as SubportfolioBaseBalanceSnapshotFor366Days_CreatedAt,
};
use super::{
    _remote::{
        Asset_ChainId,
...
pub struct SubportfolioBaseBalanceSnapshotFor366Days {
    pub user_id: User_Id,
