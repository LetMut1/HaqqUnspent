...
use crate::{
    domain_layer::data::entity::subportfolio_base_balance_snapshot_for_30_days::SubportfolioBaseBalanceSnapshotFor30Days,
...
impl ClickhouseRepository<SubportfolioBaseBalanceSnapshotFor30Days> {
    pub async fn find_history<'a>(clickhouse_client: &'a Client, by_6: &'a By6<'_>) -> Result<Vec<BalanceSnapshot>, Auditor<Error>> {
        let subportfolio_base_balance_snapshot_registry = match Self::find_subportfolio_base_balance_snapshot_history_(
            clickhouse_client,
            by_6,
            "unspentio.subportfolio_base_balance_snapshot_for_30_days",
