pub use self::{
    Amount as SubportfolioBaseBalanceSnapshotFor7Days_Amount,
    CreatedAt as SubportfolioBaseBalanceSnapshotFor7Days_CreatedAt,
};
use super::{
    _remote::{
        Asset_ChainId,
...
pub struct SubportfolioBaseBalanceSnapshotFor7Days {
    pub user_id: User_Id,
